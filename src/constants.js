...
const MAP_SONG_ID = '10008723'; // songID of the song to be used with the map
...
extract({
	...
	ROTATE_SPAWN_GROUP: (4100 + MAP_ID), // id that spawns the rotate triggers - 4101 to 4130
	MAP_TOGGLE_GROUP_NEW: (4200 + MAP_ID), // id that spawns the rotate triggers - 4201 to 4230
